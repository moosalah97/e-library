...
<div class="container">
    ...
    echo form_open_multipart('Departments/insert_chemistry',$attributes);
    ?>
    <div class="row">
        <h4>Add Books</h4>
        ...
        <div class="input-group input-group-icon">
            <select name="department">
                <option value="chemistry department" name="chemistrydepartment">chemistry</option>
            </select>
        </div>
        <div class="input-group input-group-icon">
            <select name="level">
        ...
        echo form_close();
        ?>
        <button id="logout"><a href="http://localhost/e-library/index.php/Departments/admin_home_view">Home</a></button>
    </div>
