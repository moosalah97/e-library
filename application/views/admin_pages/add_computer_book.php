...
<div class="container">
    ...
    echo form_open_multipart('Departments/insert_computer',$attributes);
    ?>
    <div class="row">
        <h4>Add Books</h4>
        <div class="input-group input-group-icon">
            <input class="book_name" name="book_name" type="text" placeholder=" Required Book name and his extension should be correct" required/>
            <div class="input-icon"><i class="fa fa-user"></i></div>
        </div>
        <div class="input-group input-group-icon">
            <select name="department">
                <option value="computer department" name="computerdepartment">computer</option>
            </select>
        </div>
        <div class="input-group input-group-icon">
            <select name="level">
