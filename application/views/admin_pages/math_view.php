...
<html>
    ...
    <body style="background-image:url('http://localhost/e-library/images/maths.jpg')">
        ...
        <div class="add">
            <button><a href="http://localhost/e-library/index.php/Departments/add_math_book">Add new book</a></button>
        ...
        if($department->department=="math department"&&$department->level=="first year"){?>
            <LI><?php echo $department->book_name;?>
                <a href="<?php echo base_url() . "index.php/Departments/remove_math/". $department->id;?> ">
